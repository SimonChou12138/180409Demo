...
<body>
    ...
    <!-- 注册 -->
    <div class="register">
        <form id="bdyz" action="informationServlet" method="post">
            <div class="tel clearfix">
                <span>手机号</span>
                <input name="phonenum" type="text" readonly="readonly" class="dfinput" value='${list[0].u_phonenum}' />
                <i>不可修改</i>
            </div>
            <div class="tel clearfix">
                <span>昵称</span>
                <input name="nickname" type="text" value="${map.u_nickname}" />
                <i></i>
            </div>
            <div class="tel clearfix">
                <span>生日</span>
                <input name="birthday" type="text" value="${map.u_birthday}" />
                <i></i>
            </div>
            <div class="tel clearfix">
                <span>省</span>
                <input name="province" type="text" value="${map.u_province}" />
                <i></i>
            </div>
            <div class="tel clearfix">
                <span>市</span>
                <input name="city" type="text" value="${map.u_city}" />
                <i></i>
            </div>
            <div class="tel clearfix">
                <span>区</span>
                <input name="district" type="text" value="${map.u_district}" />
                <i></i>
            </div>
            <div class="tel clearfix">
                <span></span>
                <input type="submit" value="保存修改" class="sub">
            </div>
        </form>
    </div>
    <!-- footer -->
